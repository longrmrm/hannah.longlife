...
public class RoundButton extends JButton {
	...
	private static final long serialVersionUID = -28611099568847684L;
	...
	protected void paintComponent(Graphics g) {
		...
		if (isEnabled())
			...
			gp = new GradientPaint(0.0F, 0.0F, Color.GRAY, 0.0F, h, Color.GRAY, true);
		g2d.setPaint(gp);
		...
		if (hover && isEnabled()) {
			...
			g2d.clip(r2d2);
			GradientPaint gp2 = new GradientPaint(0.0F, 0.0F, BUTTON_BAK_COLOR2_2, 0.0F, h / 2, BUTTON_BAK_COLOR1_2,
					true);
			g2d.setPaint(gp2);
